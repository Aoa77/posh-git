...
#
function NormalizeHtmlColor ($color) {
...
function ConsoleX_Snapshop([string] $logFile, [string] $fontSize) {
    ###################
    AssertConsoleHost;
    ###################
...
#
function MakeHtmlSpan ($text, $forecolor = "DarkYellow", $backcolor = "DarkMagenta") {
